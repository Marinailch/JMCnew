            ...
            <div class="row">
                ...
                <div class=" col-md-6">
                    <div id="about">
                        ...
                        <p>Мы многопрофильный, высококлассный медицинский центр, принципиально нового для Украины уровня
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Консультации
                                                специалистов</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Инструментальная
                                                диагностика</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Лабораторные
                                                исследования</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">Оперативное
                                                лечение</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse5">Дневной
                                                стационар</a>
                                        </h4>
                                    </div>
                                    <div id="collapse5" class="panel-collapse collapse">
                                        <div class="panel-body"> Под наблюдением врача и опытной медсестры</div>
                                    </div>
                                </div>
        ...
        <div class="col-sm-6 recommend_circle">
            <div class="wrapper">
                <div class="box">
                    ...
                    <input type="text" value="" class="dial1" data-readOnly="true" data-thickness="0.03"
                           data-fgColor="#fff" data-bgColor="#4c463a" data-width="300px" data-fontWeight="600"
                           data-font="">
