...
<!--            --><?php //var_dump($usi->getPriceForFD())?>
            ...
            <h4>Создание нового прайса без выезда на дом</h4>
            <form method="POST">
                <table class="table">
            ...
            <table class="table ">
                    ...
                    <form method="POST">
                        <td class="" style="width: 72%; border: none"> <input style="width: 100%; height: 35px;" type="text" name="name_of_method_fd"   value="<?= $item['name_of_method_fd'] ?>"></td>
